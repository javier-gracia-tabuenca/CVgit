...
{Biomedical R\&D signal-processing and HW}
...
\lanprog{Phython}{$>$1y}{ Scikit-learn, NumPy, Pandas}      
...
%	 Profile
\section{Profile}  
PhD Biomedical Engineering on advance signal processing methods and statistical analysis of short-term and overnight respiratory signals. Expanding my knowledge on machine learning. +5 years university lecturer. Espanjalainen seitsemän vuotta Suomessa.  
\\
%----------------------------------------------------------------------------------------
%	 WORK
