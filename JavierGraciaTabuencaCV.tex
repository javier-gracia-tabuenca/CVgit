...
\lanprog{Python}{$>$1y}{ Scikit-learn, NumPy, Pandas}  
...
%	 Profile
\section{Profile} 
Hands-on experience on a wide spectrum of the R\&D cycle of medical devices. Ranging from hardware design to patient testing, including embedded SW coding and advance signal processing methods. Currently expanding my knowledge on machine learning. +5 years university lecturer. Espanjalainen seitsemän vuotta Suomessa.  
\\
%----------------------------------------------------------------------------------------
%	 WORK
...
\href{https://www.youtube.com/watch?time_continue=1&v=E3D8rAG6S4Q}{“Basics of Medical Electronics” }.
	...
	\twentyitemlist
        ...
        {\href{https://www.tut.fi/}{\textbf{Tampere University of Technology}}}
        {
        \item Embedded coding a wearable, now knows as \href{https://www.ventica.net/}{Ventica®}.   }
...
\begin{twenty} % Environment for a list with descriptions
  \twentyitemlist
        ...
        \item Use 3D and laser cuter to create the mechanical parts. 
        \item Design PCB and program the electronics.
        \item Crete custom calibration and testing methods.
        ...
        {        
        \item Code respiratory flow and ECG feature extraction.
        \item Code sleep phase detection.
        \item Code non-linear analysis: DFA, SamEn, noise-limit...
